...
if (window.location.href.indexOf('CaseMember') > -1) { viewMode ? eleFocus('#newDuplicateButton') : $('#next').length > 0 ? eleFocus('#next') : eleFocus('#memberReferenceNumberNewMember') }
if (window.location.href.indexOf('CaseMemberII') > -1) { if ($('#new').attr('disabled') !== "disabled") { eleFocus('#newDuplicateButton') } else $('#next').length > 0 ? eleFocus('#next') : eleFocus('#memberReferenceNumberNewMember') }
...
if (window.location.href.indexOf('FundingAvailability') > -1) {
    if (viewMode) { $('#new').attr('disabled') === 'disabled' ? eleFocus('#wrapUpDuplicateButton') : eleFocus('#newDuplicateButton') }
    else { eleFocus('#basicSlidingFeeFundsAvailableCode') }//TODO change to bSfEffectiveDate, with basicSlidingFeeFundsAvailableCode.val = Y, may need to trigger event
};
...
if (window.location.href.indexOf("CaseEligibilityResultApprovalPackage") > -1) { viewMode ? eleFocus('#approveDuplicateButton') : eleFocus('#confirmDuplicateButton') }
...
if (window.location.href.indexOf("ProviderInformation") > -1) { viewMode ? eleFocus('#editDuplicateButton') : eleFocus('#contactEmail') }
if (window.location.href.indexOf("ProviderAddress") > -1) { viewMode ? eleFocus('#editDuplicateButton') : eleFocus('#mailingSiteHomeStreet1') }
if (window.location.href.indexOf("ProviderAccreditation") > -1) { viewMode ? eleFocus('#editDuplicateButton') : eleFocus('#accreditationType') }
if (window.location.href.indexOf("ProviderLicense") > -1) { viewMode ? eleFocus('#editDuplicateButton') : eleFocus('#licenseNumber') }
if (window.location.href.indexOf("ProviderAlias") > -1) { viewMode ? eleFocus('#addBusiness') : eleFocus('#name') }
if (window.location.href.indexOf("ProviderTaxInfo") > -1) { viewMode ? eleFocus('#newDuplicateButton') : eleFocus('#taxType') }

//SUB-SECTION START Non-collection pages
if (window.location.href.indexOf('/AlertWorkerCreatedAlert') > -1) { eleFocus('#delayApproval') }
if (window.location.href.indexOf('Alerts.htm?pageUrl=AlertWorkerCreatedAlert.htm')) { eleFocus('') }
...
if (window.location.href.indexOf("CaseChildProvider") > -1) {
    ...
    $('#providerId').blur(function() {
        if ($('#providerId').val() !== '') {
            ...
            // document.getElementById('providerId').dispatchEvent(event);
...
//SECTION START Remove unnecessary fields from Child Support Enforcement
    ...
    $($hiddenCSE).hide();
    $('#cseAbsentParentInfoLastName').parent().after('<div class="fake-custom-button fake-custom-button-nodisable centered-text flex-right" /*style="float: right;"*/ id="abpsShowHide">Toggle extra info</div>');
    ...
    $('#cseGoodCauseClaimStatus').parent().after('<div class="fake-custom-button fake-custom-button-nodisable centered-text flex-right" /*style="float: right;"*/ id="cseGoodCauseClaimStatusToggle">Toggle extra info</div>');
...
if (window.location.href.indexOf("CaseEarnedIncome") > -1) {
    ...
    hiddenCEI1.hide();
    $('#ceiIncomeType').parent().after('<div class="fake-custom-button fake-custom-button-nodisable centered-text flex-right" /*style="float: right;"*/ id="ceiShowHide1">Toggle extra info</div>');
    $('#ceiShowHide1').click(function() { $(hiddenCEI1).toggle() });
    //
    let hiddenCEI2 = $('#ceiCPUnitType, #ceiNbrUnits').parents('.form-group')
    hiddenCEI2.hide();
    $('#ceiPrjAmount').parent().after('<div class="fake-custom-button fake-custom-button-nodisable centered-text flex-right" /*style="float: right;"*/ id="ceiShowHide2">Toggle extra info</div>');
    ...
    if ($('#providerName').val().length < 1) {
        ...
        hiddenCEI3.hide();
        $('#providerSearch').parent().after('<div class="fake-custom-button fake-custom-button-nodisable centered-text flex-right" /*style="float: right;"*/ id="ceiShowHide3">Toggle extra info</div>');
...
if (window.location.href.indexOf("CaseEligibilityResultPerson") > -1) {
...
if (window.location.href.indexOf("CaseEligibilityResultOverview") > -1) {
    $('label[for="totalAnnualizedIncome"]').parent('.form-group').children('.col-lg-5').hide()
...
if (window.location.href.indexOf("CaseExpense") > -1) {
	...
	hiddenExp.hide();
	$('label[for="projectionExpenseAmount"]').parent().append('<div class="fake-custom-button fake-custom-button-nodisable centered-text flex-right" /*style="float: right;"*/ id="ceiShowHide2">Toggle extra info</div>');
    // $('#projectionExpenseAmount').parent().after('<div class="fake-custom-button fake-custom-button-nodisable centered-text flex-right" /*style="float: right;"*/ id="ceiShowHide2">Toggle extra info</div>');
...
//SUB-SECTION START Permanent fix for case notes - case notes saved when state broke them are permanently broken
	...
	fixCaseNoteDisplay()
//SUB-SECTION END Permanent fix for case notes - case notes saved when state broke them are permanently broken
...
if (window.location.href.indexOf("CaseOverview") > -1) {
    ...
    $('.form-group>div.visible-lg>label').unwrap()
...
if (window.location.href.indexOf("CaseTransfer") > -1) {
    $('div.col-lg-6').each(function() {//CaseTransfer empty div
...
if (window.location.href.indexOf("ClientSearch") > -1) {
...
//SECTION START ProviderAddress Copy Provider mailto Address
    $('#providerInput').append('<div class="custombutton fake-custom-button centered-text flex-right" /*style="float: right;"*/ id="copyMailing">Billing Form Address to Clipboard</div>');
    $('#copyMailing').click(function() {
        // copyMailing() });
...
window.addEventListener('keydown', function(e) {//Don't scroll when using spacebar to click buttons
  if(e.keyCode == 32 && (e.target.className.includes('custom-form-button') || e.target.className.includes('fake-custom-button'))) {
    e.preventDefault();
  }
});
//
...
//testing
console.log($('div.col-xs-5.col-sm-5.col-md-5.col-lg-5:not(div.col-lg-5.col-md-5.col-sm-5.col-xs-5.textR.updateParent)'))
